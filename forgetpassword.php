                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-body pb-2">
                            ...
                            <h2 class="text-uppercase text-center mb-5">Rest Password</h2>

                            <form action="handle/handlereset.php" method="post">
                                ...
                                <div class="d-flex justify-content-center">
                                    <button type="submit" name="reset"
                                        class="btn btn-danger btn-lg gradient-custom-4">Send Code</button>
                                </div>

                                <p class="text-center text-muted mt-5 mb-0"> <a href="login.php"
                                        class="fw-bold text-body">
                                        <p class="text-center fw-bolder"><?= $msg['Login'] ?> ?</p>
                                    </a></p>
                            </form>
